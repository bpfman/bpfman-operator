...
func (in *AttachInfoCommon) DeepCopyInto(out *AttachInfoCommon) {
	*out = *in
	if in.AttachId != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AttachInfoCommon.
func (in *AttachInfoCommon) DeepCopy() *AttachInfoCommon {
	if in == nil {
		return nil
	}
	out := new(AttachInfoCommon)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BpfApplicationSpec) DeepCopyInto(out *BpfApplicationSpec) {
	*out = *in
	...
	if in.Programs != nil {
		...
		*out = make(map[string]BpfApplicationProgram, len(*in))
		for key, val := range *in {
...
func (in *BpfApplicationStateSpec) DeepCopyInto(out *BpfApplicationStateSpec) {
	*out = *in
	if in.Programs != nil {
		in, out := &in.Programs, &out.Programs
		*out = make(map[string]BpfApplicationProgramState, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
func (in *BpfProgramCommon) DeepCopyInto(out *BpfProgramCommon) {
	*out = *in
	in.OldMapOwnerSelector.DeepCopyInto(&out.OldMapOwnerSelector)
}
...
func (in *FentryAttachInfoState) DeepCopyInto(out *FentryAttachInfoState) {
	*out = *in
	in.AttachInfoCommon.DeepCopyInto(&out.AttachInfoCommon)
}
...
func (in *FentryProgramInfoState) DeepCopyInto(out *FentryProgramInfoState) {
	*out = *in
	if in.AttachPoints != nil {
		...
		*out = make([]FentryAttachInfoState, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
