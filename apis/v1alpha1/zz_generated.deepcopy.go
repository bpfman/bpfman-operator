...
func (in *InterfaceSelector) DeepCopyInto(out *InterfaceSelector) {
	*out = *in
	...
	if in.NetnsInterfaces != nil {
		in, out := &in.NetnsInterfaces, &out.NetnsInterfaces
		*out = new([]NetnsInterface)
		if **in != nil {
			in, out := *in, *out
			*out = make([]NetnsInterface, len(*in))
			for i := range *in {
				(*in)[i].DeepCopyInto(&(*out)[i])
			}
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetnsInterface) DeepCopyInto(out *NetnsInterface) {
	*out = *in
	if in.Interfaces != nil {
		in, out := &in.Interfaces, &out.Interfaces
		*out = new([]string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetnsInterface.
func (in *NetnsInterface) DeepCopy() *NetnsInterface {
	if in == nil {
		return nil
	}
	out := new(NetnsInterface)
