...
// ANF-TODO: It is possible for Fentry and Fexit programs to have the same name
// but different ProgSpecificInfo.  This function won't work in those cases
// because it will just find the first one on the list.  However, I don't think
// we get the ProgSpecificInfo back from the load response.
