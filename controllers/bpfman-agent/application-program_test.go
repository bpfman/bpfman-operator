...
func TestBpfApplicationControllerCreate(t *testing.T) {
	...
	err = rc.getBpfProgram(ctx, rfentry, name, fentryAppProgramId, fentryAttachPoint, fentryBpfProg)
	...
	err = rc.getBpfProgram(ctx, rkprobe, name, kprobeAppProgramId, kprobeAttachPoint, kprobeBpfProg)
	require.NoError(t, err)
