...
func (r *NamespaceProgramReconciler) createBpfProgram(
	attachPoint string,
	rec bpfmanReconciler[bpfmaniov1alpha1.BpfNsProgram, bpfmaniov1alpha1.BpfNsProgramList],
	annotations map[string]string,
) (*bpfmaniov1alpha1.BpfNsProgram, error) {

	r.Logger.V(1).Info("createBpfNsProgram()", "Name", attachPoint,
		"Owner", rec.getOwner().GetName(), "OwnerType", rec.getRecType(), "Name", rec.getName(), "Namespace", rec.getNamespace())
...
func (r *NamespaceProgramReconciler) updateBpfStatus(
	ctx context.Context,
