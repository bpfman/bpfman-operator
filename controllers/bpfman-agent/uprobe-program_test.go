...
func TestUprobeProgramControllerCreate(t *testing.T) {
	...
	r := &UprobeProgramReconciler{ClusterProgramReconciler: cpr, ourNode: fakeNode}
...
func TestUprobeProgramControllerCreateContainer(t *testing.T) {
	var (
		name              = "fakeUprobeProgram"
		namespace         = "bpfman"
		bytecodePath      = "/tmp/hello.o"
		...
		ctx               = context.TODO()
		appProgramId      = ""
		fakePodName       = "fake-pod-1"
		fakeContainerName = "fake-container-1"
		fakePid           = int64(1001)
