...
func TestTcNsProgramControllerCreate(t *testing.T) {
	var (
		name            = "fakeTcProgram"
		namespace       = "bpfman"
	...
	s.AddKnownTypes(bpfmaniov1alpha1.SchemeGroupVersion, &bpfmaniov1alpha1.TcNsProgramList{})
	...
	cl := fake.NewClientBuilder().WithStatusSubresource(tc).WithStatusSubresource(&bpfmaniov1alpha1.BpfNsProgram{}).WithRuntimeObjects(objs...).Build()
	...
	r := &TcNsProgramReconciler{NamespaceProgramReconciler: npr, ourNode: fakeNode}
...
func TestTcNsProgramControllerCreateMultiIntf(t *testing.T) {
	var (
		name            = "fakeTcProgram"
		namespace       = "bpfman"
		bytecodePath    = "/tmp/hello.o"
