...
// UprobeNsProgramReconciler contains the info required to reconcile a UprobeNsProgram
type UprobeNsProgramReconciler struct {
	ReconcilerCommon
	ProgramNsReconcilerCommon
	currentAttachPoint *bpfmaniov1alpha1.UprobeNsAttachInfoState
}

func (r *UprobeNsProgramReconciler) getProgId() *uint32 {
...
func (r *UprobeNsProgramReconciler) getBpfmanProgType() gobpfman.BpfmanProgramType {
	return gobpfman.BpfmanProgramType_UPROBE
}

func (r *UprobeNsProgramReconciler) getProgName() string {
	return r.currentProgram.BpfFunctionName
}

func (r *UprobeNsProgramReconciler) shouldAttach() bool {
	return r.currentAttachPoint.ShouldAttach
}

func (r *UprobeNsProgramReconciler) isAttached() bool {
...
func (r *UprobeNsProgramReconciler) getUUID() string {
	return r.currentAttachPoint.UUID
}

func (r *UprobeNsProgramReconciler) getAttachId() *uint32 {
	return r.currentAttachPoint.AttachId
}

func (r *UprobeNsProgramReconciler) setAttachId(id *uint32) {
	r.currentAttachPoint.AttachId = id
}

func (r *UprobeNsProgramReconciler) setProgramAttachStatus(status bpfmaniov1alpha1.ProgramAttachStatus) {
	r.currentProgramState.ProgramAttachStatus = status
}

func (r *UprobeNsProgramReconciler) getProgramAttachStatus() bpfmaniov1alpha1.ProgramAttachStatus {
	return r.currentProgramState.ProgramAttachStatus
}

func (r *UprobeNsProgramReconciler) setCurrentAttachPointStatus(status bpfmaniov1alpha1.AttachPointStatus) {
	r.currentAttachPoint.AttachPointStatus = status
}

func (r *UprobeNsProgramReconciler) getCurrentAttachPointStatus() bpfmaniov1alpha1.AttachPointStatus {
	return r.currentAttachPoint.AttachPointStatus
}

func (r *UprobeNsProgramReconciler) getAttachRequest() *gobpfman.AttachRequest {
...
func (r *UprobeNsProgramReconciler) updateAttachInfo(ctx context.Context, isBeingDeleted bool) error {
...
func (r *UprobeNsProgramReconciler) findAttachPoint(attachInfoState bpfmaniov1alpha1.UprobeNsAttachInfoState) *int {
...
// attach point.
func (r *UprobeNsProgramReconciler) processAttachInfo(ctx context.Context) error {
...
func (r *UprobeNsProgramReconciler) updateProgramAttachStatus() {
...
func (r *UprobeNsProgramReconciler) removeAttachPoints(attachPoints []bpfmaniov1alpha1.UprobeNsAttachInfoState, attachPointsToRemove map[int]bool) []bpfmaniov1alpha1.UprobeNsAttachInfoState {
	var remainingAttachPoints []bpfmaniov1alpha1.UprobeNsAttachInfoState
...
// points.
func (r *UprobeNsProgramReconciler) getExpectedAttachPoints(ctx context.Context, attachInfo bpfmaniov1alpha1.UprobeNsAttachInfo,
) ([]bpfmaniov1alpha1.UprobeNsAttachInfoState, error) {
	nodeAttachPoints := []bpfmaniov1alpha1.UprobeNsAttachInfoState{}
	...
	if containerInfo != nil && len(*containerInfo) != 0 {
		...
		for i := range *containerInfo {
			...
			attachPoint := bpfmaniov1alpha1.UprobeNsAttachInfoState{
...
func (r *UprobeNsProgramReconciler) getProgramLoadInfo() *gobpfman.LoadInfo {
