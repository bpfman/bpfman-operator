...
func (r *BpfNsApplicationReconciler) getRecCommon() *ReconcilerCommon[bpfmaniov1alpha1.BpfNsApplicationState, bpfmaniov1alpha1.BpfNsApplicationStateList] {
...
func (r *BpfNsApplicationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, appProgram); err != nil {
		// Reconcile was triggered by BpfNsApplicationState event, get parent appProgram Object.
