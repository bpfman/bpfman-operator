...
func (r *BpfNsApplicationReconciler) getRecCommon() *ReconcilerCommon[bpfmaniov1alpha1.BpfApplicationState, bpfmaniov1alpha1.BpfApplicationStateList] {
...
func (r *BpfNsApplicationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, bpfApp); err != nil {
		...
		if errors.IsNotFound(err) {
			...
			if ownerRef == nil {
				return ctrl.Result{}, fmt.Errorf("failed getting BpfNsApplicationState Object owner")
			}
