...
func appNsProgramReconcile(t *testing.T, multiCondition bool) {
	...
	attachInfo := bpfmaniov1alpha1.XdpNsAttachInfo{
	...
	xdpProgram := bpfmaniov1alpha1.BpfNsApplicationProgram{
		...
		XDP: &bpfmaniov1alpha1.XdpNsProgramInfo{
			AttachPoints: []bpfmaniov1alpha1.XdpNsAttachInfo{attachInfo},
		},
	}
	...
	expectedBpfProg := &bpfmaniov1alpha1.BpfNsApplicationState{
		ObjectMeta: metav1.ObjectMeta{
			Name:      bpfProgName,
			Namespace: namespace,
	...
	rc := ReconcilerCommon[bpfmaniov1alpha1.BpfNsApplicationState, bpfmaniov1alpha1.BpfNsApplicationStateList]{
		Client: cl,
		Scheme: s,
	}
