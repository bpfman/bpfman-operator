...
func TestTcxNsProgramReconcile(t *testing.T) {
	var (
		name            = "fakeTcProgram"
	...
	expectedBpfProg := &bpfmaniov1alpha1.BpfNsProgram{
		ObjectMeta: metav1.ObjectMeta{
			...
			Finalizers: []string{internal.TcxNsProgramControllerFinalizer},
		},
	...
	r := &TcxNsProgramReconciler{NamespaceProgramReconciler: npr}
