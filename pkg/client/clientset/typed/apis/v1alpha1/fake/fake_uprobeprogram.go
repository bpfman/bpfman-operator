...
var uprobeprogramsResource = v1alpha1.SchemeGroupVersion.WithResource("uprobeprograms")

var uprobeprogramsKind = v1alpha1.SchemeGroupVersion.WithKind("UprobeProgram")
