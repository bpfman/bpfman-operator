...
var kprobeprogramsResource = v1alpha1.SchemeGroupVersion.WithResource("kprobeprograms")

var kprobeprogramsKind = v1alpha1.SchemeGroupVersion.WithKind("KprobeProgram")
