...
var fexitprogramsResource = v1alpha1.SchemeGroupVersion.WithResource("fexitprograms")

var fexitprogramsKind = v1alpha1.SchemeGroupVersion.WithKind("FexitProgram")
