...
var fentryprogramsResource = v1alpha1.SchemeGroupVersion.WithResource("fentryprograms")

var fentryprogramsKind = v1alpha1.SchemeGroupVersion.WithKind("FentryProgram")
