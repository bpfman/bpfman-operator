...
type BpfApplicationStateLister interface {
	...
	// Get retrieves the BpfApplicationState from the index for a given name.
	// Objects returned here must be treated as read-only.
...
// Get retrieves the BpfApplicationState from the index for a given name.
func (s *bpfApplicationStateLister) Get(name string) (*v1alpha1.BpfApplicationState, error) {
